<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm"  :inline="true" v-show="showSearch" >
      <el-form-item label="工资倍数，如按照小时计算，就是员工平均小时工资乘以倍数" prop="salaryMultiple">
        <el-input v-model="queryParams.salaryMultiple" placeholder="请输入工资倍数，如按照小时计算，就是员工平均小时工资乘以倍数" clearable
          @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item label="加班奖金" prop="bonus">
        <el-input v-model="queryParams.bonus" placeholder="请输入加班奖金" clearable @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item label="加班类型" prop="overtimeTypeId">
        <el-input v-model="queryParams.overtimeTypeId" placeholder="请输入加班类型" clearable
          @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item label="员工编号" prop="employeeId">
        <el-input v-model="queryParams.employeeId" placeholder="请输入员工编号" clearable @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item label="0不补休，1补休，默认0" prop="isTimeOff">
        <el-input v-model="queryParams.isTimeOff" placeholder="请输入0不补休，1补休，默认0" clearable
          @keyup.enter.native="handleQuery" />
      </el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button type="primary" plain icon="Plus" @click="handleAdd"
          v-hasPermi="['hr:overtime:add']">新增</el-button>
      </el-col>
      <el-col :span="1.5">
    ...
    <el-table v-loading="loading" :data="overtimeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="工资倍数，如按照小时计算，就是员工平均小时工资乘以倍数" align="center" prop="salaryMultiple" />
      <el-table-column label="加班奖金" align="center" prop="bonus" />
      <el-table-column label="加班类型" align="center" prop="overtimeTypeId" />
      <el-table-column label="员工编号" align="center" prop="employeeId" />
      <el-table-column label="0小时，1天，默认0，计数加班工资的类型" align="center" prop="countType" />
      <el-table-column label="备注" align="center" prop="remark" />
      <el-table-column label="1启用，0禁用，默认1" align="center" prop="status" />
      <el-table-column label="0不补休，1补休，默认0" align="center" prop="isTimeOff" />
    ...
    <!-- 添加或修改员工加班管理对话框 -->
     <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules">
        <el-form-item label="工资倍数，如按照小时计算，就是员工平均小时工资乘以倍数" prop="salaryMultiple">
          <el-input v-model="form.salaryMultiple" placeholder="请输入工资倍数，如按照小时计算，就是员工平均小时工资乘以倍数" />
        </el-form-item>
        <el-form-item label="加班奖金" prop="bonus">
          <el-input v-model="form.bonus" placeholder="请输入加班奖金" />
        </el-form-item>
        <el-form-item label="加班类型" prop="overtimeTypeId">
          <el-input v-model="form.overtimeTypeId" placeholder="请输入加班类型" />
        </el-form-item>
        <el-form-item label="员工编号" prop="employeeId">
        ...
        <el-form-item label="0不补休，1补休，默认0" prop="isTimeOff">
          <el-input v-model="form.isTimeOff" placeholder="请输入0不补休，1补休，默认0" />
        </el-form-item>
        <el-form-item label="状态/逻辑删除" prop="isDeleted">
...
export default {
  ...
  data () {
    return {
      ...
      rules: {
        status: [
          { required: true, message: "1启用，0禁用，默认1不能为空", trigger: "change" }
        ],
        createTime: [
  ...
  methods: {
    ...
    handleDelete (row) {
      ...
      this.$modal.confirm('是否确认删除员工加班管理编号为"' + ids + '"的数据项？').then(function () {
    ...
    /** 导出按钮操作 */
    handleExport () {
      this.download('hr/overtime/export', {
        ...this.queryParams
