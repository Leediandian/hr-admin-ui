  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm"  :inline="true" v-show="showSearch" >
      ...
      <el-form-item label="调薪日期" prop="asDate">
        <el-date-picker clearable v-model="queryParams.asDate" type="date" value-format="yyyy-MM-dd"
          placeholder="请选择调薪日期">
        </el-date-picker>
      </el-form-item>
      <el-form-item label="调前薪资" prop="beforeSalary">
        <el-input v-model="queryParams.beforeSalary" placeholder="请输入调前薪资" clearable
          @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item label="调后薪资" prop="afterSalary">
        <el-input v-model="queryParams.afterSalary" placeholder="请输入调后薪资" clearable @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item label="调薪原因" prop="reason">
        <el-input v-model="queryParams.reason" placeholder="请输入调薪原因" clearable @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button type="primary" plain icon="Plus" @click="handleAdd"
          v-hasPermi="['hr:adjustSalary:add']">新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="success" plain icon="Edit" :disabled="single" @click="handleUpdate"
          v-hasPermi="['hr:adjustSalary:edit']">修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="danger" plain icon="Delete" :disabled="multiple" @click="handleDelete"
          v-hasPermi="['hr:adjustSalary:remove']">删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="warning" plain icon="Download" @click="handleExport"
          v-hasPermi="['hr:adjustSalary:export']">导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="adjustSalaryList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="调薪编号" align="center" prop="id" />
    ...
    <!-- 添加或修改员工调薪对话框 -->
     <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules">
        ...
        <el-form-item label="调薪日期" prop="asDate">
          <el-date-picker clearable v-model="form.asDate" type="date" value-format="yyyy-MM-dd" placeholder="请选择调薪日期">
          </el-date-picker>
        </el-form-item>
        <el-form-item label="调前薪资" prop="beforeSalary">
...
<script>
import { listAdjustSalary, getAdjustSalary, delAdjustSalary, addAdjustSalary, updateAdjustSalary } from "@/api/hr/adjustSalary";
...
export default {
  ...
  methods: {
    ...
    handleDelete (row) {
      ...
      this.$modal.confirm('是否确认删除员工调薪编号为"' + ids + '"的数据项？').then(function () {
    ...
    /** 导出按钮操作 */
    handleExport () {
      this.download('hr/adjustSalary/export', {
        ...this.queryParams
