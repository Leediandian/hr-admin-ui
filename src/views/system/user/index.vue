  ...
  <div class="app-container">
    <el-row :gutter="20">
      ...
      <el-col :span="20" :xs="24">
        ...
        <el-row :gutter="10" class="mb8">
          <el-col :span="1.5">
            <el-button type="primary" plain icon="Plus" @click="handleAdd1"
              v-hasPermi="['system:user:add']">根据员工档案新增账号</el-button>
          </el-col>
          <!-- <el-col :span="1.5">
    ...
    <el-dialog :title="title" v-model="open" width="600px" append-to-body>
      <el-form :model="form" :rules="rules" ref="userRef" label-width="80px">
        ...
        <el-divider content-position="center" v-if="title == '根据员工档案添加用户'">员工信息</el-divider>
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item v-if="form.userId == undefined" label="用户账号" prop="userName">
              <el-input v-model="form.userName" placeholder="注：账号与员工-工号一致" maxlength="30" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
...
function handleSelect (item) {
  reset();
  form.value.nickName = item.name
  form.value.userName = item.workId
  form.value.phonenumber = item.phone
  form.value.email = item.email
  form.value.sex = item.gender
  form.value.employeeName = item.name
  form.value.employeeId = item.employeeId
  form.value.postIds.push(item.post.postId)
